...
ProviderId = Literal["antigravity", "claude", "codex", "cursor", "grok", "opencode", "qwen"]
...
PROVIDER_IDS: Sequence[ProviderId] = ("antigravity", "claude", "codex", "cursor", "grok", "opencode", "qwen")
